...
class Application extends Api {
  ...
  static connectDevice = (data: { connected_device: string }) => {
    const response = this.post("/mobile/settings/connect_device", data);
    return response;
  };
  static disconnectDevice = (data: { disconnected_device: string }) => {
    const response = this.post("/mobile/settings/disconnect_device", data);
    return response;
  };
}
